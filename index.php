					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">6304299466</li>
								<li class="icon solid fa-envelope"><a href="#">shyamsundharmaccha@gmail.com</a></li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: Shyam & Kevin Viswas</li>
							</ul>
						</div>
					</section>
